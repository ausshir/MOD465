...
add wave -noupdate -radix hexadecimal /impulse_tb/sut/clk
add wave -noupdate -radix hexadecimal /impulse_tb/sut/reset
add wave -noupdate -radix hexadecimal /impulse_tb/sut/symbol_clk
add wave -noupdate -radix decimal /impulse_tb/sut/in
add wave -noupdate -radix decimal /impulse_tb/sut/out
add wave -noupdate -radix hexadecimal /impulse_tb/sut/i
add wave -noupdate -radix hexadecimal /impulse_tb/sut/symbol
add wave -noupdate -radix hexadecimal /impulse_tb/sut/count4
add wave -noupdate -radix decimal /impulse_tb/sut/bin
add wave -noupdate -radix decimal /impulse_tb/sut/bin_out
...
update
WaveRestoreZoom {20301 ns} {23713 ns}
