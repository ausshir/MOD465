...
add wave -noupdate -height 15 /total_path_tb/gold_tx_tb/bin
...
add wave -noupdate -height 15 /total_path_tb/sam_clk_en
add wave -noupdate -height 15 /total_path_tb/sym_clk_en
add wave -noupdate -format Analog-Step -height 84 -max 129953.99999999999 -min -130722.0 /total_path_tb/rx_up_sync_inphase
...
add wave -noupdate -format Analog-Step -height 84 -max 122349.0 -min -122349.0 /total_path_tb/rx_sig_mapped
...
WaveRestoreCursors {{Cursor 1} {869730 ns} 0} {{Cursor 2} {298389 ns} 0}
